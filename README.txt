...
5. Changing the prefix (Optional)
...
-- This will not work with a requirements file, you have to install the package through git.
7. Run the bot: python main.py

============== SECTION 1.2 - Bad Users =======================

This source code for a bot is intended to make the bot (a.k.a. a Bad user) trash. Here are some example of bad users
...
PYTHON. WE WILL NOT HELP YOU SET UP THE BOT UP EITHER! USE AT YOUR OWN RISK!
...
Orignal Bot Invite: https://app.revolt.chat/bot/01GQ6RADXPSXPF6NW4CBXXE0VV
