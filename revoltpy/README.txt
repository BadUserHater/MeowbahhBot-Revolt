...
CREATED BY: IdiotCreatureHater
For: Revolt.py
Requires Python 3.9 or higher.

NOTICE: This is an old version of the Meowbahh bot that used to be made with Revolt.py but is now using Voltage.
We will not provide support for this version.
...
5. CHANGING PREFIX (Optional)
-- Head to the top where it says: return "++" and replace ++ with the prefix you want.
